...
public class AccommodationController {
    ...
    @GetMapping
    public ResponseEntity<List<PlaceDto>> getAccomodations(
        ...
        return new ResponseEntity<>(accommodationService.getAccommodations(latitude,longitude,distance, keyword, isMuslimFriendly, pageNum, pageSize, firebaseUuid), HttpStatus.OK);
    }
